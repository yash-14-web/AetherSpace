...
def get_or_create_dm_conversation(workspace, user_a, user_b):
    ...
    between two active workspace members.
    """
    if not workspace.has_user(user_a) or not workspace.has_user(user_b):
        raise PermissionDenied("Both participants must be active members of the workspace.")
